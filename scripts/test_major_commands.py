...
TESTS = [
    ...
    CommandTest(
        name="Project memory v0.7 stage",
        command="NEXUS現在地",
        expected="v0.7 file / production support / UI prep completed",
    ),
    CommandTest(
        name="Project memory v0.8 next stage",
        command="NEXUS現在地",
        expected="v0.8 planning, then dashboard prototype",
    ),
    CommandTest(
